...
export function view(ctrl, args, extras) {
	...
	return m('div', [
		...
		m('.col-sm-10', [
			...
			m('.col-sm-8.business-table', m('div', [
				m('.form-group.col-sm-12', [
					m('.row', [
						m('.form-group.col-sm-4', [
							m('label.control-label', t('Fleet Name') + ':'), m('div', m('input.form-control', {
				...
				m('.form-group', [
					m('.col-sm-5', [
						...
						m('select.fullwidth.form-control[multiple][size=20]', {
							onblur: function (ev) {
					...
					m('.col-sm-2.verticalcenter', {
						style: {
							'margin-top': '10em'
						}
					}, [
						m('button.btn-lg btn-default', {
