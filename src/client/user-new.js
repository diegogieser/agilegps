...
import appState from './appState';const Device = require('../common/models/Device');
            ...
            m('form.form-horizontal', [
                Object.keys(ctrl.user).map(function (key) {
                    ...
                    if (key === 'isAdmin' || key === 'isOrgAdmin') {
                        return m('div.form-group', [m('label.col-md-4 control-label', keyhelper(key) + ':'), m('div.col-md-8', m('input[type=checkbox]', {
                            onclick: function() {
                    ...
                    //     })))])
                        ...
                        return formitem(ctrl.user, key, 4, 8, key === 'username' && ctrl.editing);
