				...
				Object.keys(ctrl.vehicle).map(function(key) {
					if (key === 'device') {
						if (state.user.isAdmin) {
							...
							return m('div.form-group', [m('label.col-md-4 control-label', keyhelper(key) + ':'), m('div.col-md-8', m('select.form-control', {
							...
							return m('div.form-group', [
								...
								m('div.col-md-8', m('select.form-control[disabled]', {
									value: ctrl.vehicle[key]
								}, m('option', {
									value: ctrl.vehicle[key]
								}, ctrl.vehicle[key])))
