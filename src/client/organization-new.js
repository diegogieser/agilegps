...
module.exports.view = function(ctrl) {
    ...
    return m('div', [
        ...
        m('.business-table col-sm-6 ', [
            m('.btn.center', editing ? t('Edit Organization') : t('Create Organization')),
            m('form.form-horizontal', [
                Object.keys(org).map(function (key) {
                    return m('div.form-group', [m('label.col-md-2 control-label', t(keyhelper(key)) + ':'), m('div.col-md-10', m('input.form-control', {
